...
export const Form = ({ component }) => {
	...
	const postNews = async (values) => {
		...
		console.log(values);
		await axios
			.post("https://code-6z3x.onrender.com/api/news/addNews", formData, config)
			.then((res) => {
				console.log(res);
	...
	return (
		...
		<ScrollView>
			<View style={{ alignSelf: "center", width: width - 40, paddingTop: 45 }}>
						...
						<View>
							...
							>
								{({
									...
									const { title, images, content, campus, venue } = values;
									return (
										<View style={{ top: -50 }}>
											<FormInput
											...
											{component === "Event" ? (
												<View>
													...
													<FormInput
														...
														value={venue}
														placeholder="Venue"
														TextInputStyle={[styles.input, { marginTop: -25 }]}
													/>
												</View>
											) : null}
											<View
											...
											<View>
												...
												<Dropdown
													...
													onChange={(value) =>
														setFieldValue("campus", value.value)
													}
													//   renderLeftIcon={() => (
